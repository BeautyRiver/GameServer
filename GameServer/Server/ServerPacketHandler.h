...
private:
    ...
    static void onRoomList(ClientSession* session, RoomListReq* pkt, Server* server);
    ...
    static void sendError(ClientSession* session, ErrorCode code, const char* detail);
};